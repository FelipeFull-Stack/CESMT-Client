	...
	return (
		<>
			...
			{showPopup && (
				...
				<div className={styles.popup} style={{ display: 'flex', position: 'absolute', top: '5%', left: '50%', transform: 'translateX(-50%)', overflow: 'auto', border: '5px solid red', borderRadius: '5px', minWidth: '300px', width: '800px' }}>
